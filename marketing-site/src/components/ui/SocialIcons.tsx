...
export function XIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
      <path d="M13.63 10.53 20.5 3h-1.63l-5.97 6.53L8.13 3H3l7.2 10.32L3 21h1.63l6.3-6.9 5.04 6.9H21l-7.37-10.47Zm-2.23 2.44-.73-1.01L5.4 4.14h2.5l4.68 6.47.73 1.01 6.08 8.4h-2.5l-4.99-6.98Z" />
    </svg>
  );
}
