          ...
          <table className="w-full min-w-[1080px] border-collapse text-left text-sm">
            <thead>
              <tr className="border-b border-paper/10 bg-ink-raised text-xs font-semibold uppercase tracking-wide text-paper-dim">
                ...
                <th className="px-6 py-4">Target Outcome</th>
            ...
            <tbody>
              {tracks.map((track) => (
                <tr key={track.track} className="border-b border-paper/10 last:border-0">
                  ...
                  <td className="px-6 py-5 text-paper-muted">{track.outcome}</td>
                  ...
                  <td className="px-6 py-5 text-paper-muted">{track.deliveryModel}</td>
                </tr>
              ))}
            </tbody>
          </table>
